...
X = torch.tensor(([2, 9], [1, 5], [3, 6], [5, 9], [5, 8]), dtype=torch.float) # 5 X 2 tensor
y = torch.tensor(([92], [100], [89], [75], [80]), dtype=torch.float) # 5 X 1 tensor
xPredicted = torch.tensor(([2, 9]), dtype=torch.float) # 1 X 2 tensor
