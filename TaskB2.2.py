...
class Neural_Network(nn.Module):
    ...
    def forward(self, X):
        ...
        a = torch.FloatTensor(self.z) 
        self.z2 = torch.tanh(a) # activation function
        print("Activation tanh : " + str(self.z2));
        self.z3 = torch.matmul(self.z2, self.W2)
        a1 = torch.FloatTensor(self.z3) 
        o = torch.tanh(a1) # activation function
        print("Activation tanh : " + str(o));
